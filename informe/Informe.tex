...
\begin{document}
	...
	\begin{itemize}
		...
		\item[$\circ$] El algoritmo greedy puede mejorarse considerablemente si se implementan los algoritmos de Prim o Kruskal, que además de asegurar la solución correcta, tienen complejidades de tipo logarítmica, que es mucho más deseable.
	\end{itemize}
